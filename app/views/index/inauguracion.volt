    ...
    <div class="container">
        <div align="center">
            <div class="curriculum-bg-header modal-header " align="left">
                ...
                <h3>
                    <small>
                        <em style=" color:#FFF !important;">Para que puedan ir conociendo de las instalaciones les
                            dejamos una descripción breve, junto a las fotos y videos de la inauguración. </em>
                    </small>
                </h3>
            ...
            <div class="curriculum-bg-form borde-top" align="left">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <h2 class="headline font-1-bold fs34"
                            style="font-size:22px;line-height: 36px;margin-bottom: 20px;">
                                <span>
                                    El Edificio, ubicado en Bouquet Roldán entre calles Roca y Belgrano, tiene una
                                superficie del
                                terreno de casi mil metros. Tiene siete Niveles.
                                </span>
                        </h2>
                    </div>
                    <div class="col-md-5 col-md-offset-1">
                        <p class="text-left"> Los dos primeros niveles son los destinados a las oficinas administrativas del <strong>IMPS
                                y Melewe</strong>,
                            con una superficie construida de 2.250m y semicubierta de 59m, distribuidos de la
                            siguiente de manera:</p>

                        <p>
                            Un subsuelo para cocheras con 24
                            módulos (se compartirán con los niveles superiores); planta
                            baja, donde funcionarán a la derecha las oficinas de <strong>Melewe</strong>, al frente
                            Atención
                            a Afiliados y
                            oficinas administrativas, y a la izquierda el ingreso a la escalera principal
                            que comunica los
                            siete niveles;</p>

                        <p> En el primer piso estará la
                            oficina del Administrador, un salón de usos múltiples para
                            cuarenta personas y oficinas administrativas del <strong>IMPS</strong>;</p>


                    </div>
                    <div class="col-md-5">
                        <p>Los niveles segundo, tercero,
                            cuarto y quinto, con una superficie cubierta de 310 metros cada
                            uno, están destinados a su comercialización. Con la renta de esos alquileres se
                            obtendrán
                            ingresos para que el edificio sea autosustentable económicamente, es decir que
                            se puede cubrir
                            sus gastos de funcionamiento. Esto resulta indispensable para no tener que
                            utilizar fondos
                            previsionales para ese fin. Hay que destacar que el interior de estos pisos se
                            concluirán en una
                            tercera etapa (actualmente se está desarrollando el proyecto ejecutivo, cómputo
                            y presupuesto) y
                            estará supeditada a las necesidades de los inquilinos. El segundo nivel cuenta
                            con una
                            vinculación interna, que permitirña una expansion de la Administración cuando
                            los futuros
                            Consejos de Administración lo consideren necesario.
                        </p>
